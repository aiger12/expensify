  ...
  return ( 
    ...
    <ScreenWrapper className="flex-1">
        <View className="flex-row justify-between items-center p-4">
            <Text className={`${colors.heading} font-bold text-3xl shadow-sm`}>ExpensifyL</Text>
          ...
          <Text style={styles.themeToggleButtonText}>Dafault</Text> 
            ...
            <TouchableOpacity onPress={()=> navigation.navigate('HomeDark')} style={styles.themeToggleButton}> 
          <Text style={styles.themeToggleButtonText}>Dark</Text> 
        </TouchableOpacity> 
